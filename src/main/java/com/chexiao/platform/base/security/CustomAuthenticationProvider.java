...
import com.chexiao.platform.base.bean.UserProfile;
...
public class CustomAuthenticationProvider extends
    ...
    protected UserDetails retrieveUser(String username,
        ...
        com.chexiao.platform.base.bean.User user = userService.findByUsername(username);
    ...
    private List<GrantedAuthority> getGrantedAuthorities(com.chexiao.platform.base.bean.User user){
